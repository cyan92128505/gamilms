...
module.exports = function (app, passport, Models, build_app) {
  var config = {
    ...
    create_file_tree: require(process.cwd() + "/api/ionicfile.js")
      .create_file_tree,
    ...
    switch_step_code: require(process.cwd() + "/api/ionicfile.js")
      .switch_step_code,
  ...
  //admin
  app.get(
    project_name + "/admin/:custom_query",
    config.admin_ctrl.findALL(Models)
  );
  ...
  app.get(
    project_name + "/switch_step_code/:trip_step",
    config.switch_step_code(Models)
  );
