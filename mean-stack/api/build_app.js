...
module.exports = function(Models) {
    ...
    build_event.on('build', function(option) {
        build_process.exec('ionic build android', {
            cwd: build_path
    ...
    build_event.on('store_user_app', function(option) {
        ...
        fs_extra.move(build_path + '/platforms/android/build/outputs/apk/android-debug.apk',
    ...
    return {
        ...
        gamilms_java_version: function gamilms_java_version(req, res, next) {
            ...
            java_process.exec('java -version', {
                cwd: build_path
            }, function(err, stdout, stderr) {
                if (err) {
